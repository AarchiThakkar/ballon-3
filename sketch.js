  ...
  if(gameState === PLAY){
    ...
    //adding gravity
     ...
     balloon.bounceOff(edges[0]);
           ...
           balloon.collide(bottomObstaclesGroup);
           balloon.collide(topObstaclesGroup);
...
gameState=END;
  ...
  topObstaclesGroup.setVelocityXEach(-4);
          bottomObstaclesGroup.setVelocityXEach();
          barGroup.setVelocityXEach();
